...
const Instructions = () => {
  return (
    <article className="text-center text-md fw-semi-bold">
        Click "OPEN" and "CLOSE" to navigate sidebar <br />
        Click "SHIFT UP" to shift contents of the sidebar in an upward direction <br />
